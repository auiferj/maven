package com.mvnbook.account.web;
...
import com.mvnbook.account.service.AccountService;
import com.mvnbook.account.service.AccountServiceException;
import com.mvnbook.account.service.SignUpRequest;
...
public class SignUpServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (id == null || id.length() == 0 || email == null || email.length() == 0 || name == null || name.length() == 0
				...
				|| confirmPassword.length() == 0 || captchaKey == null || captchaKey.length() == 0
		...
		String bath=req.getScheme()+"://"+req.getServerName()+":"+req.getServerPort()+req.getContextPath()+"/";
		request.setActivateServiceUrl(bath + "activate");
